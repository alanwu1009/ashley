...
public class OrRuleExpression implements RuleExpression, RuleExecutable {
    ...
    public boolean apply() throws RuleApplyingException {
        ...
        if (passed == null) {
            passed = this.hasReachedRule ? false : true;
        }
    ...
    public RuleResult getRuleResult() {
        this.ruleResult.type = RuleResult.TYPE_EXPRESSION_OR;
